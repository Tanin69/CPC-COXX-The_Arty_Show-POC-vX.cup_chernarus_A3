...
if (count _tbWP < 3)  exitWith {hint "Le premier argument doit être un tableau avec 3 éléments\nScript interrompu."};

private _tbVeh = [];
private _wpUnload = objNull;
private _wpDest = objNull;
...
//_grpInf setVariable ["PLUTO_ORDER", "IGNORE"];
...
_wpUnload = _grpInf addWaypoint [getMarkerPos (_tbWP#1), 5];
