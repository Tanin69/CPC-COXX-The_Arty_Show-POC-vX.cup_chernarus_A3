...
Description:
	...
	- the marker is not in the blacklisted area   
...
_randomPos = [_markerZone, _wpPosParams, _blacklist] call int_fnc_findRdmSafePos;
...
[
    ...
    15, 
    [0,0,0], 
	["true", format["nul = [this] spawn {[group (_this select 0), %1, %2, [%3,""UNCHANGED"",""UNCHANGED"",""NO CHANGE"",""NO CHANGE""], %4] call int_fnc_lucyVehicleRandomPatrol;};", str _markerZone, str _wpPosParams, str(_wpParams #0), str _blackList]]
